...
# -*- coding: utf-8 -*-
#
# Online Experiments with jsPsych documentation build configuration file, created by
# sphinx-quickstart on Thu Jan  4 10:46:19 2018.
#
...
data = {
    'teaching_server_fqdn': 'jspsychlearning.ppls.ed.ac.uk'
}
...
project = 'Online Experiments with jsPsych'
...
htmlhelp_basename = 'OnlineExperimentswithjsPsychdoc'
...
latex_documents = [
    (master_doc, 'OnlineExperimentswithjsPsych.tex', 'Online Experiments with jsPsych',
     'Alisdair Tullo', 'manual'),
]
...
man_pages = [
    (master_doc, 'onlineexperimentswithjspsych', 'Online Experiments with jsPsych',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OnlineExperimentswithjsPsych', 'Online Experiments with jsPsych',
     author, 'OnlineExperimentswithjsPsych', 'One line description of project.',
     'Miscellaneous'),
]
